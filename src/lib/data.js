	...
	PCRE: {
		...
		flags: [
			...
			{ U: { full: "ungreedy", desc: "Make quantifiers lazy" } },
			{
				A: {
					full: "anchored",
					desc: "Anchor to the start of pattern or at the end of most recent match",
				},
			},
	...
	JAVA: {
		...
		flags: [
			...
			{ s: { full: "single line", desc: "Dot matches newline" } },
			{
				u: {
					full: "unicode case",
					desc: "Case insensitive matching, affects unicode characters aswell",
				},
			},
			{ x: { full: "extended", desc: "Ignore whitespace" } },
			{
				U: {
					...
					desc: "Enabled unicode support for predefined classes",
				},
			},
		],
		delimiters: ['"'],
