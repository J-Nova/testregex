var Regex101Explainer = function () {
    ...
    function n(e, t) {
        for (var r = "", a = 1, i = 0; i < e.length; i++) {
            ...
            if (isGroupType(o.type)) {
                ...
                W == FLAVOR.JS && "[^]" === o.group_contents ? r += F(P("Note:") + " Avoid this construct, use " + b(".") + " or " + N("[\\s\\S]") + " instead.") : o.children && (r += n(o.children, o)),
                r += "</ul>";
    ...
    function c(e) {
        ...
        return W == FLAVOR.JS && "[^]" === e.group_contents ? t += " match any character" : (t += " match a single character ", t += "^" === e.contents.charAt(1) ? "not present" : "present", t += " in the list below"),
        t
    }
    function o(e) {
        var t = e.replace("^", "");
    ...
    Z.explain = function (i) {
        ...
        var s;
        switch (W) {
            case FLAVOR.JS: s = /^[img]$/,
                j = "Javascript";
                break;
            case FLAVOR.PYTHON: s = /^[imgsxu]$/,
                j = "Python";
                break;
            case FLAVOR.PCRE:
        ...
        if (Regex101Colorizer.hasError()) {
            ...
            for (var p = _.uniq(i.options), l = i.options, u = 0; u < p.length; u++) 
                s.test(p[u]) || (h += '<li class="treeview_error">' + I(p[u]) + "-modifier does not exist in " + FLAVOR[W] + " (or is not yet supported by regex101.com)</li>"),
                l = l.replace(p[u], "");
